...
const replacements = [
  ...
  { p: /#22C55E33/g, r: "var(--primary-dim)" },
  { p: /#22C55E66/g, r: "var(--primary-dim)" },
  { p: /#22C55E44/g, r: "var(--primary-dim)" },
  { p: /#22C55E88/g, r: "var(--primary-dim)" },
  { p: /#22C55E11/g, r: "var(--primary-glow)" },
  { p: /#22C55E22/g, r: "var(--primary-glow)" },

  { p: /#22C55E/g, r: "var(--primary)" },
  { p: /#16A34A/g, r: "var(--primary)" },
  { p: /#4ADE80/g, r: "var(--secondary)" },
  { p: /#86EFAC/g, r: "var(--tertiary)" },
  { p: /#020D05/g, r: "var(--bg)" },
  { p: /#040F07/g, r: "var(--bg-deep)" },
...
files.forEach(f => {
  if (f.includes('VineIntro.jsx')) return;
  if (f.includes('EcoBg.jsx')) return;
  if (f.includes('ThemeContext.jsx')) return;

          ...
          return (
            <div key={i} className="nge-card" data-label={`// ${crop.crop.toUpperCase()}`}
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div>
                  <p style={{
                    color: 'var(--primary)', fontSize: 13, margin: '0 0 4px',
          ...
          {CROP_ANALYTICS.map((crop, i) => {
            ...
            return (
              <button key={i} onClick={() => toggleCrop(crop.crop)}
                style={{
                  padding: '8px 16px', borderRadius: 2, fontSize: 11, fontWeight: 700,
              ...
              {CROP_ANALYTICS.map((crop, i) => {
                ...
                return (
                  <tr key={i} style={{ borderBottom: '1px solid var(--primary-glow)', transition: 'all 0.15s' }} className="hover:bg-[var(--primary-glow)]">
                    ...
                    <td style={{
                      padding: '16px 14px', fontFamily: "'Share Tech Mono', monospace", fontSize: 13,
                    ...
                    <td style={{ padding: '16px 14px' }}>
                      <span style={{
                        background: '#0A1A0A', color: '#00FF41', border: '1px solid #00FF41', letterSpacing: 1,
